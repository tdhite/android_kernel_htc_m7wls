...
int m7wl_front_camera_id(void)
{
	...
	rc = pm8xxx_gpio_config(CAM_PIN_FRONT_CAMERA_ID, &cam_id_pmic_gpio_release);
	if (rc) {
		pr_err("%s: cam_id_pmic_gpio_release=%d\n", __func__, rc);
		goto config_camid_failed;
	}
...
void __init m7wl_init_cam(void)
{
	...
	front_camera_id = m7wl_front_camera_id();
